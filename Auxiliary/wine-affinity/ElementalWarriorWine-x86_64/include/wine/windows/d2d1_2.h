/*** Autogenerated by WIDL 9.14 from ../include/d2d1_2.idl - Do not edit ***/
...
static __WIDL_INLINE HRESULT ID2D1DeviceContext1_GetImageLocalBounds(ID2D1DeviceContext1* This,ID2D1Image *image,D2D1_RECT_F *local_bounds) {
