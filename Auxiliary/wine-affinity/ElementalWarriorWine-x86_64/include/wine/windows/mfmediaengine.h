/*** Autogenerated by WIDL 9.14 from ../include/mfmediaengine.idl - Do not edit ***/
...
static __WIDL_INLINE HRESULT IMFMediaEngineEx_IsProtected(IMFMediaEngineEx* This,BOOL *is_protected) {
