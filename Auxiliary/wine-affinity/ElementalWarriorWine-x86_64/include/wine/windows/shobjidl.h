/*** Autogenerated by WIDL 9.14 from ../include/shobjidl.idl - Do not edit ***/
...
#else
/*** IUnknown methods ***/
static __WIDL_INLINE HRESULT IPreviewHandler_QueryInterface(IPreviewHandler* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static __WIDL_INLINE ULONG IPreviewHandler_AddRef(IPreviewHandler* This) {
    return This->lpVtbl->AddRef(This);
}
static __WIDL_INLINE ULONG IPreviewHandler_Release(IPreviewHandler* This) {
    return This->lpVtbl->Release(This);
}
/*** IPreviewHandler methods ***/
static __WIDL_INLINE HRESULT IPreviewHandler_SetWindow(IPreviewHandler* This,HWND hwnd,const RECT *rect) {
    return This->lpVtbl->SetWindow(This,hwnd,rect);
}
static __WIDL_INLINE HRESULT IPreviewHandler_SetRect(IPreviewHandler* This,const RECT *rect) {
    return This->lpVtbl->SetRect(This,rect);
}
static __WIDL_INLINE HRESULT IPreviewHandler_DoPreview(IPreviewHandler* This) {
    return This->lpVtbl->DoPreview(This);
}
static __WIDL_INLINE HRESULT IPreviewHandler_Unload(IPreviewHandler* This) {
    return This->lpVtbl->Unload(This);
}
static __WIDL_INLINE HRESULT IPreviewHandler_SetFocus(IPreviewHandler* This) {
    return This->lpVtbl->SetFocus(This);
}
static __WIDL_INLINE HRESULT IPreviewHandler_QueryFocus(IPreviewHandler* This,HWND *hwnd) {
    return This->lpVtbl->QueryFocus(This,hwnd);
}
static __WIDL_INLINE HRESULT IPreviewHandler_TranslateAccelerator(IPreviewHandler* This,MSG *msg) {
...
#else
/*** IUnknown methods ***/
static __WIDL_INLINE HRESULT IPreviewHandlerVisuals_QueryInterface(IPreviewHandlerVisuals* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static __WIDL_INLINE ULONG IPreviewHandlerVisuals_AddRef(IPreviewHandlerVisuals* This) {
    return This->lpVtbl->AddRef(This);
}
static __WIDL_INLINE ULONG IPreviewHandlerVisuals_Release(IPreviewHandlerVisuals* This) {
    return This->lpVtbl->Release(This);
}
/*** IPreviewHandlerVisuals methods ***/
static __WIDL_INLINE HRESULT IPreviewHandlerVisuals_SetBackgroundColor(IPreviewHandlerVisuals* This,COLORREF color) {
    return This->lpVtbl->SetBackgroundColor(This,color);
}
static __WIDL_INLINE HRESULT IPreviewHandlerVisuals_SetFont(IPreviewHandlerVisuals* This,const LOGFONTW *logfont) {
    return This->lpVtbl->SetFont(This,logfont);
}
static __WIDL_INLINE HRESULT IPreviewHandlerVisuals_SetTextColor(IPreviewHandlerVisuals* This,COLORREF color) {
